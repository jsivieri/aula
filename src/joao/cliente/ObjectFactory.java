 ...
 * generated in the joao.cliente package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculaResponse_QNAME = new QName("http://joao/", "calculaResponse");
    private final static QName _Calcula_QNAME = new QName("http://joao/", "calcula");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: joao.cliente
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://joao/", name = "calculaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://joao/", name = "calcula")
